...
void OnTick()
{
   ...
   if (Hour() == 8 && Minute() == 0  || Hour() == 12 && Minute() == 0  || Hour() == 16 && Minute() == 0  || Hour() == 20 && Minute() == 0  || Hour() == 0 && Minute() == 0 ) // total de compras
   {
      ...
      if (OrdersTotal() == 50)
      {
         OrderClose(OrderTicket(), lotaje,OrderOpenPrice(), slippage, clrBlue);
         Print("**********Orden cerrada!");
      }
